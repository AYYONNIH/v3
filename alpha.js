...
-------------------------------------------------------
✓ Ayyon Bot ( RECODE ) : 
https://youtube.com/c/ASEPU
-------------------------------------------------------
» Help Me 1k Subs Ayyon Bot
--------------------------------------------------------------**/
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Ayyon Bot Whatsapp_*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `Ayyon Bot Whatsapp`, "footerText": "*_© Ayyon Bot Whatsapp_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const ftex = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `*_${tampilUcapan} - ${jmn} WIB_*\n*_Tanggal : ${calender}_*`,
                 "title": `_${tampilUcapan}_`,
                 'jpegThumbnail': imageTime
                        }
	                  } 
                     }
// VN
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Ayyon Bot Whatsapp_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer Ayyon Bot Whatsapp\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_©Ayyon Bot*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('')
}
...
───────────────────`
buttons = [
{buttonId:`allmenu`, buttonText: {displayText: '☑️ALL MENU☑️'}, type: 1},
{buttonId:`sc`,buttonText:{displayText: '💌SCRIPT BOT💌'},type:1},
{buttonId:`listmenu`, buttonText: {displayText: '🛐SIMPEL MENU🛐'}, type: 1}
]
const menuuu = {
    contentText: `${stamtus}`,
    footerText: `_Masih Proses tahap Pengembangan_`,
    buttons: buttons,
    headerType: 1
}
await alpha.sendMessage(from, menuuu, MessageType.buttonsMessage, {quoted: ftex})
		break
case 'allmenu':
...
await alpha.sendMessage(from, allmenu, MessageType.buttonsMessage, {quoted: ftex})
		break
case 'groupmenu':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
stamtus = `❏ 「 \`\`\`MENU GROUP\`\`\` 」
...
alpha.sendMessage(from, sendBtnVeryy, MessageType.buttonsMessage, {quoted:ftex, contextInfo: { mentionedJid: [sender]}})
...
//LUPA
case 'sound1':
hh = fs.readFileSync('./audio/sound1.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound2':
hh = fs.readFileSync('./audio/sound2.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound3':
hh = fs.readFileSync('./audio/sound3.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound4':
hh = fs.readFileSync('./audio/sound4.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound5':
hh = fs.readFileSync('./audio/sound5.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound6':
hh = fs.readFileSync('./audio/sound6.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound7':
hh = fs.readFileSync('./audio/sound7.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound8':
hh = fs.readFileSync('./audio/sound8.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound9':
hh = fs.readFileSync('./audio/sound9.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
case 'sound10':
hh = fs.readFileSync('./audio/sound10.mp3')
await alpha.sendMessage(from, hh, MessageType.audio, {qouted: fvoc, mimetype: 'audio/mp4', ptt:true})
break
...
//LUPA
       case 'maker3d': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} Ayyon Bot Whatsapp`)
					teksnya = args.join(" ")
					sticWait(from)
					anu = await fetchJson(`https://xnxxapi.herokuapp.com/api/maker3d?text=${teksnya}&apikey=xnxx`)
					buffer1 = await getBuffer(anu.result.results)
					alpha.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
					break
...
alpha.sendMessage(from, tahta, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'snow': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, snow, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'pubg': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, pubg, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'smoke': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, smoke, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'bneon': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, bneon, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'matrix': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, matrix, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'gplay': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, gplay, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'splay': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, splay, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'text3d': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, text3d, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'tfire': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, tfire, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'lithg': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, lithg, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'wall': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, wall, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'dropair': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, dropair, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'logocrs': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, logocrs, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'flame': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, flame, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'flower': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, flower, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'wolf': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, wolf, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'nulis': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, catat, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'ganz': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, ganz, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'cans': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, cans, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'naruto': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, naruto, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'logoff': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, logoff, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'barcode': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, bccode, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'skytext':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, sky, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'cslogo': 
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length < 1) return reply('*Teks nya mana?*') 
...
alpha.sendMessage(from, cslogo, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'meme':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
sticWait(from)
anu = await fetchJson(`https://api.lolhuman.xyz/api/random/meme?apikey=${lolkey}`)
...
footerText: '*_©Ayyon Bot Whatsapp_*',
buttons: gbutsan,
headerType: 4
}
...
break    
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
	...
	alpha.sendMessage(from,nowmm ,MessageType.audio,{mimetype:'audio/mp4',quoted: mek})
		})
		})
		break 
	case 'igstory': 
...
ini_list.push({
"displayName": `Developer Ayyon Bot Whatsapp`,
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Ayyon Bot Whatsapp`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Ayyon Bot Whatsapp`,
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Ayyon Bot Whatsapp`}, MessageType.location)
...
break
            ...
            break
				case 'attp':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
					if (!c) return reply(`Teks Nya Mana Kak?\nContoh :\n${prefix}attp Ayyon Bot Whatsapp`)
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY Ayyon Bot Whatsapp`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `Ayyon Bot Whatsapp`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `Ayyon Bot Whatsapp`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
